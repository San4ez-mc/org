    ...
    <div style={{ ...card, padding: 16 }}>
      ...
      {editing ? (
        <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 8 }}>
          {steps.map((s, i) => (
            <div key={i} style={{ display: 'grid', gridTemplateColumns: '30px 180px 1fr 1fr 26px', gap: 8, alignItems: 'center' }}>
        ...
        <>
          ...
          <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 6 }}>
            {(process.steps ?? []).map((s, i) => (
              <div key={i} style={{ display: 'grid', gridTemplateColumns: '24px 190px 1fr', gap: 10, fontSize: 13 }}>
