  ...
  await withCompanyDrive(companyId, async () => {
    for (const post of posts) {
      const prompt = [
        ...
        '- Окремо про ЧИСЛА: терміни, кількості, частоту, відсотки бери тільки з даних вище.',
        '  Не названо — «Потребує уточнення: узгодити норматив». «Протягом 3 робочих днів»,',
        '  якого ніхто не встановлював, за тиждень стане нормою, за яку почнуть питати.',
